...
languages = {
    ...
    'Korean': 'ko', 'Italian': 'it', 'Portuguese': 'pt', 'Arabic': 'ar', 'Dutch': 'nl',
    'Swedish': 'sv', 'Turkish': 'tr', 'Greek': 'el', 'Hebrew': 'he', 'Hindi': 'hi', 'Indonesian': 'id',
...
followed by the step-by-step instructions."""
    ...
    if selected_restrictions:
        prompt += f"Make sure the recipe adheres to the following dietary restrictions: {', '.join(selected_restrictions)}."
